...
class Sprite(pygame.sprite.Sprite):
    ...
    def update(self):
      ...
      boundary_hit = False
      # Check for collision with the left or right boundaries and reverse direction
      if self.rect.left <= 0 or self.rect.right >= 500:
        self.velocity[0] = -self.velocity[0]
        boundary_hit = True  
      # Check for collision with the top or bottom boundaries and reverse direction
